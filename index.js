...
/*case 'promoteall': case 'alladmin':
      if (!isGroup) return reply(ind.groupo())
      if (!isOwner) return reply(ind.admin())
      ...
      alpha.groupParticipantsUpdate(m.chat, [members_id], 'promote')
      break
